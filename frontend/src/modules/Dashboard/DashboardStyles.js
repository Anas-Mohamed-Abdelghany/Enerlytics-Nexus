...
export const s = {
  ...
  strategySection:   { marginBottom: "1.5rem", padding: "1.5rem", background: "rgba(255,255,255,0.95)", border: "1px solid rgba(0,0,0,0.1)", borderRadius: "20px" },
  sectionHeader:     { display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "1.25rem" },
  sectionTitle:      { fontSize: "1rem", fontWeight: "700", textTransform: "uppercase", letterSpacing: "0.06em", color: "#000", margin: 0 },
  strategyActionRow: { display: "flex", gap: "1.25rem", flexWrap: "wrap", marginBottom: "1.25rem" },
  settingsPanel:     { background: "rgba(255,255,255,0.9)", borderRadius: "12px", padding: "1.25rem", marginBottom: "1.5rem", border: "1px solid var(--border-color)", display: "flex", flexDirection: "column", gap: "1rem" },
  settingsGroup:     { display: "flex", flexDirection: "column", gap: "0.75rem" },
  groupLabel:        { fontSize: "0.75rem", fontWeight: "700", color: "#06b6d4", textTransform: "uppercase", letterSpacing: "0.08em" },
  settingItem:       { display: "flex", flexDirection: "column", gap: "0.4rem" },
  settingsDivider:   { height: "1px", background: "rgba(0,0,0,0.1)", opacity: 0.5 },
  statusArea:        { display: "flex", alignItems: "center", gap: "0.75rem", padding: "0.75rem 1rem", background: "rgba(0,0,0,0.05)", borderRadius: "8px", border: "1px solid rgba(0,0,0,0.1)", color: "#000", fontSize: "0.85rem", fontFamily: "monospace" },
  statusText:        { flex: 1, color: "#000" },
  ...
  radioLabel:        { display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", padding: "0.5rem 1rem", borderRadius: "10px", background: "rgba(0,0,0,0.05)", border: "1px solid rgba(0,0,0,0.1)", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)", userSelect: "none" },
  ...
  radioText:         { fontSize: "0.85rem", color: "#000", fontWeight: "600", transition: "all 0.2s" },
  radioTextActive:   { color: "#3b82f6", fontWeight: "800" },
};
